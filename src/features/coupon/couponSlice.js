...
export const getCoupons = createAsyncThunk("coupon/get-coupons", 
async (thunkAPI) => {
    try{
...
export const deleteACoupon = createAsyncThunk("coupon/delete-coupon", 
  async (id,thunkAPI) => {
      try{
            ...
            .addCase(createCoupon.pending, (state) => {
              ...
              .addCase(getACoupon.pending,(state) => {
                ...
                .addCase(getACoupon.fulfilled,(state, action) => {
                    ...
                    state.couponExpired = action.payload[0].expired;
                })
                ...
                .addCase(updateACoupon.fulfilled, (state, action) => {
                  ...
                  state.isError = false;
                  state.isSuccess = true;
                  state.updateaCoupon = action.payload;
                })
